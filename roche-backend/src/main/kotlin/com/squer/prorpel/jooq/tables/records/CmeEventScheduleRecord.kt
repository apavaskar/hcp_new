...
open class CmeEventScheduleRecord() : TableRecordImpl<CmeEventScheduleRecord>(CmeEventSchedule.CME_EVENT_SCHEDULE), Record11<String?, String?, String?, String?, String?, OffsetDateTime?, OffsetDateTime?, OffsetDateTime?, String?, String?, String?> {
    ...
    override fun field1(): Field<String?> = CmeEventSchedule.CME_EVENT_SCHEDULE.ID
    override fun field2(): Field<String?> = CmeEventSchedule.CME_EVENT_SCHEDULE.UPDATED_BY
    override fun field3(): Field<String?> = CmeEventSchedule.CME_EVENT_SCHEDULE.EVENT_ID
    override fun field4(): Field<String?> = CmeEventSchedule.CME_EVENT_SCHEDULE.CREATED_BY
    override fun field5(): Field<String?> = CmeEventSchedule.CME_EVENT_SCHEDULE.EVENT_VENUE
    override fun field6(): Field<OffsetDateTime?> = CmeEventSchedule.CME_EVENT_SCHEDULE.EVENT_DATE
    override fun field7(): Field<OffsetDateTime?> = CmeEventSchedule.CME_EVENT_SCHEDULE.UPDATED_ON
    override fun field8(): Field<OffsetDateTime?> = CmeEventSchedule.CME_EVENT_SCHEDULE.CREATED_ON
    override fun field9(): Field<String?> = CmeEventSchedule.CME_EVENT_SCHEDULE.STALE_ID
    override fun field10(): Field<String?> = CmeEventSchedule.CME_EVENT_SCHEDULE.EVENT_TOPIC
    override fun field11(): Field<String?> = CmeEventSchedule.CME_EVENT_SCHEDULE.INVITE_TYPE
    ...
    override fun value1(value: String?): CmeEventScheduleRecord {
        this.id = value
        return this
    }

    override fun value2(value: String?): CmeEventScheduleRecord {
        this.updatedBy = value
        return this
    }

    override fun value3(value: String?): CmeEventScheduleRecord {
        this.eventId = value
        return this
    }

    override fun value4(value: String?): CmeEventScheduleRecord {
        this.createdBy = value
        return this
    }

    override fun value5(value: String?): CmeEventScheduleRecord {
        this.eventVenue = value
        return this
    }

    override fun value6(value: OffsetDateTime?): CmeEventScheduleRecord {
        this.eventDate = value
        return this
    }

    override fun value7(value: OffsetDateTime?): CmeEventScheduleRecord {
        this.updatedOn = value
        return this
    }

    override fun value8(value: OffsetDateTime?): CmeEventScheduleRecord {
        this.createdOn = value
        return this
    }

    override fun value9(value: String?): CmeEventScheduleRecord {
        this.staleId = value
        return this
    }

    override fun value10(value: String?): CmeEventScheduleRecord {
        this.eventTopic = value
        return this
    }

    override fun value11(value: String?): CmeEventScheduleRecord {
        this.inviteType = value
        return this
    }

    override fun values(value1: String?, value2: String?, value3: String?, value4: String?, value5: String?, value6: OffsetDateTime?, value7: OffsetDateTime?, value8: OffsetDateTime?, value9: String?, value10: String?, value11: String?): CmeEventScheduleRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
    ...
    /**
     * Create a detached, initialised CmeEventScheduleRecord
     */
