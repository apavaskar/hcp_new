...
open class CmtLocationRecord() : TableRecordImpl<CmtLocationRecord>(CmtLocation.CMT_LOCATION), Record14<OffsetDateTime?, String?, OffsetDateTime?, String?, String?, String?, String?, String?, Long?, String?, String?, String?, String?, String?> {
    ...
    override fun field1(): Field<OffsetDateTime?> = CmtLocation.CMT_LOCATION.UPDATED_ON
    override fun field2(): Field<String?> = CmtLocation.CMT_LOCATION.CI_NAME
    override fun field3(): Field<OffsetDateTime?> = CmtLocation.CMT_LOCATION.CREATED_ON
    override fun field4(): Field<String?> = CmtLocation.CMT_LOCATION.EXTERNAL_ID
    override fun field5(): Field<String?> = CmtLocation.CMT_LOCATION.UPDATED_BY
    override fun field6(): Field<String?> = CmtLocation.CMT_LOCATION.PARENT_ID
    override fun field7(): Field<String?> = CmtLocation.CMT_LOCATION.NAME
    override fun field8(): Field<String?> = CmtLocation.CMT_LOCATION.STATUS_ID
    override fun field9(): Field<Long?> = CmtLocation.CMT_LOCATION.STALE_ID
    override fun field10(): Field<String?> = CmtLocation.CMT_LOCATION.HEIRARCHY_ID
    override fun field11(): Field<String?> = CmtLocation.CMT_LOCATION.ID
    override fun field12(): Field<String?> = CmtLocation.CMT_LOCATION.CREATED_BY
    override fun field13(): Field<String?> = CmtLocation.CMT_LOCATION.SAP_CODE
    override fun field14(): Field<String?> = CmtLocation.CMT_LOCATION.DIVISION_ID
    ...
    override fun value1(value: OffsetDateTime?): CmtLocationRecord {
        this.updatedOn = value
        return this
    }

    override fun value2(value: String?): CmtLocationRecord {
        this.ciName = value
        return this
    }

    override fun value3(value: OffsetDateTime?): CmtLocationRecord {
        this.createdOn = value
        return this
    }

    override fun value4(value: String?): CmtLocationRecord {
        this.externalId = value
        return this
    }

    override fun value5(value: String?): CmtLocationRecord {
        this.updatedBy = value
        return this
    }

    override fun value6(value: String?): CmtLocationRecord {
        this.parentId = value
        return this
    }

    override fun value7(value: String?): CmtLocationRecord {
        this.name = value
        return this
    }

    override fun value8(value: String?): CmtLocationRecord {
        this.statusId = value
        return this
    }

    override fun value9(value: Long?): CmtLocationRecord {
        this.staleId = value
        return this
    }

    override fun value10(value: String?): CmtLocationRecord {
        this.heirarchyId = value
        return this
    }

    override fun value11(value: String?): CmtLocationRecord {
        this.id = value
        return this
    }

    override fun value12(value: String?): CmtLocationRecord {
        this.createdBy = value
        return this
    }

    override fun value13(value: String?): CmtLocationRecord {
        this.sapCode = value
        return this
    }

    override fun value14(value: String?): CmtLocationRecord {
        this.divisionId = value
        return this
    }

    override fun values(value1: OffsetDateTime?, value2: String?, value3: OffsetDateTime?, value4: String?, value5: String?, value6: String?, value7: String?, value8: String?, value9: Long?, value10: String?, value11: String?, value12: String?, value13: String?, value14: String?): CmtLocationRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
    ...
    /**
     * Create a detached, initialised CmtLocationRecord
     */
